...
import { Plus, Pencil, Trash2, Search, X, Save, Loader2, Package } from 'lucide-react';
              ...
              <div className="flex-1 overflow-y-auto px-6 py-5 space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <input value={form.image} onChange={e => setForm(p => ({ ...p, image: e.target.value }))}
                    ...
                    className="w-full px-3 py-2.5 rounded-xl border border-border bg-background text-sm focus:outline-none focus:border-primary transition-colors" />
                  {form.image && (
                    <img src={form.image} alt="preview" className="w-full h-32 object-cover rounded-xl border border-border mt-2" />
                  )}
                </div>
